...
[Repository README](../README.md) | [Docs index](README.md) | [Getting started](getting-started.md) | [Configuration](configuration.md) | [CI](ci.md) | [Authoring tests](authoring-tests.md) | [BDD tests](bdd-tests.md) | [Testing utilities](testing-utilities.md) | [Gremlins](gremlins.md) | [Lighthouse and performance](lighthouse-performance-ci.md)
...
These are the main local output folders created by the test and reporting commands:

- `playwright-report/`: Playwright HTML report output for the main suite and other Playwright-backed report commands
- `test-results/`: raw Playwright output including screenshots, videos, traces, and suite-specific result folders
- `lighthouse-report/`: browsable native Lighthouse HTML bundle generated by `npm run test:lighthouse:report`
- `test-results/lighthouse/`: raw Lighthouse JSON and HTML audit output

For GitHub Pages publishing, PR artifacts, and the combined Pages bundle, see [CI](ci.md).
